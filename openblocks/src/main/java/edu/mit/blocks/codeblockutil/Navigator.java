...
//    	System.err.println("debug::Navigator Line317\n");
//    	
//    	JPanel test = new JPanel();
//    	test.add((JComponent)scroll.getViewport());
//    	return test;
//    	
        return scroll;
    }
    ...
    private class ExplorerSwitcher extends JPanel {
        ...
        private ExplorerSwitcher() {
            ...
            leftLabel.setFont(new Font("SansSerif", Font.PLAIN, LABEL_HEIGHT));
            ...
            rightLabel.setFont(new Font("SansSerif", Font.PLAIN, LABEL_HEIGHT));
            ...
            mainLabel.setFont(new Font("SansSerif", Font.BOLD, 15));
