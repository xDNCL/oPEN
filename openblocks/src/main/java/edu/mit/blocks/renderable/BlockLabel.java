...
public class BlockLabel implements MouseListener, MouseMotionListener, KeyListener {
    ...
    public final static Font blockFontSmall_Bold = new Font("SansSerif", Font.BOLD, 7);

    public final static Font blockFontMedium_Bold = new Font("SansSerif", Font.BOLD, 10);

    public final static Font blockFontLarge_Bold = new Font("SansSerif", Font.BOLD, 12);

    public final static Font blockFontSmall_Plain = new Font("SansSerif", Font.PLAIN, 7);

    public final static Font blockFontMedium_Plain = new Font("SansSerif", Font.PLAIN, 10);

    public final static Font blockFontLarge_Plain = new Font("SansSerif", Font.PLAIN, 12);
