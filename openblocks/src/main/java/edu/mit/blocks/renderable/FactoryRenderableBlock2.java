...
/**
 * FactoryRenderableBlock2 extends RenderableBlock and is used within FactoryBlockDrawers.
 * Unlike its superclass RenderableBlock, FactoryRenderableBlock2 does not move or 
 ...
 * 
 * When a mouse is pressed over a FactoryRenderableBlock2, a new RenderableBlock instance is 
 * created on top of it to receive further mouse events and a new Block instance is created
 * in the background.  
 */
public class FactoryRenderableBlock2 extends RenderableBlock {
    ...
    /**
     * Constructs a new FactoryRenderableBlock2 instance.
     * @param workspace The workspace in use
     * @param widget the parent widget of this
     * @param blockID the Long ID of its associated Block instance
     */
    public FactoryRenderableBlock2(Workspace workspace, WorkspaceWidget widget, Long blockID) {
