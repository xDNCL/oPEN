...
public class Block implements ISupportMemento {
    ...
    protected String pageLabel = null;
    protected String genusName;

    //block connection information
    protected List<BlockConnector> sockets;
    protected BlockConnector plug;
    protected BlockConnector before;
    protected BlockConnector after;
