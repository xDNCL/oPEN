...
public class BlockConnectorShape {
    ...
    private Point2D addDataConnection(GeneralPath blockPath, String connectionShape, boolean startFromTop, boolean convexRight) {
        ...
        switch (connectionShapeInt) {
            ...
            case 100:
            	_lineTo(0, DATA_PLUG_HEIGHT * 0.2f);
            	_lineTo(NORMAL_DATA_PLUG_WIDTH, DATA_PLUG_HEIGHT * 0.2f);
            	_lineTo(NORMAL_DATA_PLUG_WIDTH, DATA_PLUG_HEIGHT * 0.35f);
            	_lineTo(NORMAL_DATA_PLUG_WIDTH * 0.4f, DATA_PLUG_HEIGHT * 0.35f);
            	_lineTo(NORMAL_DATA_PLUG_WIDTH * 0.4f, DATA_PLUG_HEIGHT * 0.65f);
            	_lineTo(NORMAL_DATA_PLUG_WIDTH, DATA_PLUG_HEIGHT * 0.65f);
            	_lineTo(NORMAL_DATA_PLUG_WIDTH, DATA_PLUG_HEIGHT * 0.8f);
            	_lineTo(0, DATA_PLUG_HEIGHT * 0.8f);
            	_lineTo(0, DATA_PLUG_HEIGHT);
